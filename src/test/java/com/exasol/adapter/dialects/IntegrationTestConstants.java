...
public final class IntegrationTestConstants {
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-12.0.0-hive-2.0.6.jar";
    ...
    public static final String JDBC_DRIVER_NAME = "HiveJDBC42.jar";
